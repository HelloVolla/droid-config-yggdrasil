...
%define vendor volla
%define rpm_device yggdrasilx

%define vendor_pretty Volla
%define device_pretty Volla PhoneX
...
#Disable auto requires processing because we added libmtk-ril.so
AutoReqProv: no

%include droid-configs-device/droid-configs.inc
%include patterns/patterns-sailfish-device-adaptation-yggdrasilx.inc
%include patterns/patterns-sailfish-device-configuration-yggdrasilx.inc
